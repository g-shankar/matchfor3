...
export function ImageJigsaw({voiceName,onRecord,onHome,onMaze}){
 ...
 const styleFor=(piece,clip=true)=>({'--piece-image':`url(${image})`,'--piece-size':`${cols*100}% ${rows*100}%`,'--piece-position':position(piece.slot,cols,rows),...(clip?{clipPath:shapes[piece.slot%shapes.length]}:{})});
