  ...
  return (
    <>
      ...
      <main>
        ...
        {page==='games'&&<ShivaniGameArcade onHome={()=>setPage('home')} onRunner={()=>setPage('runner')} onSave={result=>setProgress(p=>({...p,sessions:[...p.sessions,{date:Date.now(),duration:result.duration,count:8,worldId:'mathGames',skillId:result.skillId||result.mode,goal:8,completed:true}].slice(-365)}))}/>} 
